...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/简单通用文章系统后台管理模板/common.css"/>
    <link rel="stylesheet" type="text/css" href="css/简单通用文章系统后台管理模板/main.css"/>
</head>
<body>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎${sessionScope.Username}使用『学习猿地』博客程序，建博的首选工具。</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="test_tech/testAjax.jsp"><i class="icon-font">&#xe001;</i>测试Ajax</a>
